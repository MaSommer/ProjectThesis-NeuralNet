...
keep_probability_dropout = [1.00, 1.00] #first element is input layer and second is hidden layers
...
run_description = "Keep_prob_dopout is [1.0, 1.0] and one hot vector 0.000 -> 0.006 with 0.003 in step. Soft label = True"
