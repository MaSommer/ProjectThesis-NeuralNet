...
class CaseGenerator():
    ...
    def __init__(self, input_data, output_data, output_normalized_data, time_lags_sp, time_lags_ftse, one_hot_vector_interval, one_hot_size):
        self.cases = []
    ...
    def add_data(self, input_data, output_data, output_normalized_data, time_lags_ftse):
        ...
        for day_nr in range(0, number_of_days):
            ...
            for key in output_normalized_data:
                for day in range(1, time_lags_ftse + 1):
                    if (day_nr - day < 0):
